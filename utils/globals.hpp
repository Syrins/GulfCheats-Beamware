...
#include "../classes/ents/dropped_item.hpp"
#include "../classes/ents/ore.hpp"
#include "../classes/ents/stash.hpp"
#include "../classes/ents/animal.hpp"
#include "../classes/ents/basenpc.hpp"
...
public:
	...
	struct aimbot
	{
		...
		std::map<int, bool> psilent;		// if aimbot should utilize psilent
	} aimbot;
